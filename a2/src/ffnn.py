...
if __name__ == "__main__":
    ...
    parser.add_argument("-lr", "--learning-rate", type=float, default=3e-5,                     help="learning rate")
    ...
    model = FFNN(input_dim=len(vocab), hidden_dim=args.hidden_dim, num_layers=args.num_layers).to(device)
